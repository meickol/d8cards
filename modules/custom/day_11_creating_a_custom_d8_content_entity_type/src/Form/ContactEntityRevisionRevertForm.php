...
class ContactEntityRevisionRevertForm extends ConfirmFormBase {
   ...
   *
   * @var \Drupal\day_11_creating_a_custom_d8_content_entity_type\Entity\ContactEntityInterface
   */
  protected $revision;
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    drupal_set_message(t('Contact entity %title has been reverted to the revision from %revision-date.', ['%title' => $this->revision->label(), '%revision-date' => $this->dateFormatter->format($original_revision_timestamp)]));
   ...
   *
   * @param \Drupal\day_11_creating_a_custom_d8_content_entity_type\Entity\ContactEntityInterface $revision
   *   The revision to be reverted.
   * @param \Drupal\Core\Form\FormStateInterface $form_state
   *   The current state of the form.
   *
   * @return \Drupal\day_11_creating_a_custom_d8_content_entity_type\Entity\ContactEntityInterface
