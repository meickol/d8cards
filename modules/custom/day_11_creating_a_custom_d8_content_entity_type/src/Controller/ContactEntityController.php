...
namespace Drupal\day_11_creating_a_custom_d8_content_entity_type\Controller;
 ...
 *
 * @package Drupal\day_11_creating_a_custom_d8_content_entity_type\Controller
 */
class ContactEntityController extends ControllerBase implements ContainerInjectionInterface {
   ...
   *
   * @param \Drupal\day_11_creating_a_custom_d8_content_entity_type\Entity\ContactEntityInterface $contact_entity
  ...
  public function revisionOverview(ContactEntityInterface $contact_entity) {
    ...
    foreach (array_reverse($vids) as $vid) {
      /** @var \Drupal\day_11_creating_a_custom_d8_content_entity_type\ContactEntityInterface $revision */
